...
namespace Lin.Editor.Asset
{
    public class AssetSummaryWindow : EditorWindow
    {
        ...
        public static void Show(string assetPath)
        {
        ...
        {
            // 加载UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Plugins/Lin/Scripts/Editor/Asset/AssetSummaryWindow/AssetSummaryWindow.uxml");
        ...
        private void LoadExistingComment()
        {
            ...
            titleColorField.value = ExtractColorFromComment(summary.title);
