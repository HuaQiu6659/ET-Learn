...
public static class EditorConst
{
    ...
    public const string MAIN_SCENE_PATH = "Assets/Plugins/Lin/Scenes/Main.unity";
    ...
    /// <summary> dll转TextAsset输出路径 </summary>
    public const string HOTFIX_ASSEMBLIES_OUTPUT_DIRECTORY = "Assets/Prefabs/Hotfix";
#endif
